...
class Plugin extends YakPress
{
	public static function create($args, $assoc_args)
	{
		...
		$file_to_create = array(
			...
			"$plugin_dir/$plugin_namespace/Providers/ServicesProvider.php" => self::mustache_render('providers-services.mustache', $data),
			"$plugin_dir/$plugin_namespace/Providers/RoutesProvider.php" => self::mustache_render('providers-routes.mustache', $data),
			"$plugin_dir/$plugin_namespace/Providers/HooksProvider.php" => self::mustache_render('providers-hooks.mustache', $data),
			"$plugin_dir/$plugin_namespace/Providers/FeaturesProvider.php" => self::mustache_render('providers-features.mustache', $data),
