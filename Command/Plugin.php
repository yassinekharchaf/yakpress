...
class Plugin extends YakPress
{
	public static function create($args, $assoc_args)
	{
		...
		$file_to_create = array(
			...
			"$plugin_dir/$plugin_namespace/Providers/RolesProvider.php"      => self::mustache_render('commun/providers-roles.mustache', $data),
			...
			"$plugin_dir/$plugin_namespace/Providers/ImageSizesProvider.php" => self::mustache_render('commun/providers-image-size.mustache', $data),
			"$plugin_dir/$plugin_namespace/Providers/BlocksProvider.php"     => self::mustache_render('commun/providers-blocks.mustache', $data),
			...
			"$plugin_dir/config/roles.php"                                   => self::mustache_render('commun/config-roles.mustache', $data),
			"$plugin_dir/config/blocks.php"                                  => self::mustache_render('commun/config-blocks.mustache', $data),
			"$plugin_dir/config/image-size.php"                              => self::mustache_render('commun/config-image-size.mustache', $data),
