...
class Theme extends YakPress
{
	public static function create($args, $assoc_args)
	{
		...
		$file_to_create = array(
			"$theme_dir/routes/action.php"                                => self::mustache_render('theme/routes-action.mustache', $data),
			"$theme_dir/$theme_namespace/Providers/ServicesProvider.php"  => self::mustache_render('theme/providers-services.mustache', $data),
			"$theme_dir/$theme_namespace/Providers/RoutesProvider.php"    => self::mustache_render('theme/providers-routes.mustache', $data),
			"$theme_dir/$theme_namespace/Providers/HooksProvider.php"     => self::mustache_render('theme/providers-hooks.mustache', $data),
			"$theme_dir/$theme_namespace/Providers/FeaturesProvider.php"  => self::mustache_render('theme/providers-features.mustache', $data),
			"$theme_dir/$theme_namespace/Providers/ImageSizeProvider.php" => self::mustache_render('theme/providers-image-size.mustache', $data),
			"$theme_dir/$theme_namespace/Providers/MenuProvider.php"      => self::mustache_render('theme/providers-menus.mustache', $data),
			"$theme_dir/$theme_namespace/Providers/SupportProvider.php"   => self::mustache_render('theme/providers-supports.mustache', $data),
			"$theme_dir/$theme_namespace/Http/Requests/Validate.php"      => self::mustache_render('theme/http-request-validate.mustache', $data),
			...
			"$theme_dir/config/features.php"                              => self::mustache_render('theme/config-features.mustache', $data),
			"$theme_dir/config/hooks.php"                                 => self::mustache_render('theme/config-hooks.mustache', $data),
