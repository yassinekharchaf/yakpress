...
class Theme extends YakPress
{
	public static function create($args, $assoc_args)
	{
		...
		$file_to_create = array(
			...
			"$theme_dir/$theme_namespace/Providers/RolesProvider.php"      => self::mustache_render('commun/providers-roles.mustache', $data),
			"$theme_dir/$theme_namespace/Providers/ImageSizesProvider.php" => self::mustache_render('commun/providers-image-size.mustache', $data),
			...
			"$theme_dir/$theme_namespace/Providers/ScriptsProvider.php"    => self::mustache_render('theme/providers-scripts.mustache', $data),
			"$theme_dir/$theme_namespace/Providers/BlocksProvider.php"     => self::mustache_render('commun/providers-blocks.mustache', $data),
			"$theme_dir/$theme_namespace/Http/Requests/Validate.php"       => self::mustache_render('commun/http-request-validate.mustache', $data),
			"$theme_dir/$theme_namespace/Setup.php"                        => self::mustache_render('theme/setup.mustache', $data),
			...
			"$theme_dir/config/image-size.php"                             => self::mustache_render('commun/config-image-size.mustache', $data),
			"$theme_dir/config/menus.php"                                  => self::mustache_render('theme/config-menus.mustache', $data),
			"$theme_dir/config/scripts.php"                                => self::mustache_render('theme/config-scripts.mustache', $data),
			"$theme_dir/config/supports.php"                               => self::mustache_render('theme/config-supports.mustache', $data),
			"$theme_dir/config/roles.php"                                  => self::mustache_render('commun/config-roles.mustache', $data),
			"$theme_dir/config/blocks.php"                                 => self::mustache_render('commun/config-blocks.mustache', $data),
